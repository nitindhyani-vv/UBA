        ...
        <div class="row">
            <div class="col-12">
                ...
                if (isset($_POST['teamSelected']) || isset($_SESSION['rosterSelected']) || isset($_POST['divisionSelected']) || isset($_SESSION['divisionSelected'])) {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="<?= $base_url ?>/dashboard/roster.php?reset=y" class="backTeamBtn"><i
                                    class="fas fa-chevron-left"></i> Select Team</a>
                            <hr>
                        </div>
                    </div>
                    ...
                    if (isset($_POST['teamSelected']) || isset($_SESSION['rosterSelected'])) {
                        ...
                        ?>
                        <h4>Division Roster: '
                            <?php echo $_SESSION['divisionSelected']; ?>'
                        </h4>
                        <hr>
                        <div class="row">
