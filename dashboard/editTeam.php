            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <form action="process/teamEdits.php" method="post">
                        <input type="hidden" name="id" id="team_id" value="<?php echo $teamDeets['id']; ?>">
                    ...
                    <div class="col-9">
                        <div class="form-group">
                            <input type="button" class="btn btn-danger" id="delete_team" value="Delete Team">
                        </div>
...
<script>
    $('#delete_team').on('click',function(){
        ...
        var oldTeamName = $('#oldTeamName').val();
    ...
    if (confirm("Are you sure you want to delete Team: "+oldTeamName))
  {
	    $.ajax({
            ...
            window.location.href = "<?=$base_url?>/dashboard/editTeam.php";
