...
<div class="container">
    <div class="row">
            ...
            <table id="released_bowlers_table_home" class="display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            //  if($singleScoreData['currentstatus']=='Suspended'){ echo 'Released Bowlers';} else{ 
        ...
        <div class="col-12">
            ...
            <?php echo count($dataFetchedSeasonTour);
             if($_SESSION['userrole'] != 'districtmanager') {?>
            ...
            <?php echo count($dataFetchedEvents); if($_SESSION['userrole'] != 'districtmanager') {?>
