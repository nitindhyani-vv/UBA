...
<div class="users">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <?php
                    ...
                    ?>
                <a href="<?=$base_url?>/dashboard/roster.php" class="backTeamBtn"><i class="fas fa-chevron-left"></i>
                    Back to Roster</a>
                <hr>
                <?php
                        }else{
                     ?>
                <a href="<?=$base_url?>/dashboard/teamroster.php" class="backTeamBtn"><i
                        class="fas fa-chevron-left"></i> Back to Roster</a>
                <hr>
                <?php    
                        }
                    ?>
                ...
                <form action="process/bowlerEdits.php" method="post" id="editbowler">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bowlerID" class="readonly" id="bowlerID"
                                    pattern="[0-9].{2,}+-[0-9].{4,}" value="<?php echo $dataFetched['bowlerid']; ?>"
                                    required placeholder="Enter Bowler's Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="bowlerName">Name</label>
                                <input type="text" name="bowlerName" id="username"
                                    value="<?php echo $dataFetched['name']; ?>" required
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nickname1" id="nickname1"
                                    value="<?php echo $dataFetched['nickname1']; ?>" required
                                    placeholder="Enter Bowler's Nickname">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nickname1">Entering Average</label>
                                <input type="text" name="enteringAverage" id="enteringAverage"
                                    value="<?php echo $dataFetched['enteringAvg']; ?>" required class="readonly"
                                    placeholder="Enter Entering Average">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="ubaAverage" id="sanctionNumber"
                                    value="<?php echo $dataFetched['ubaAvg']; ?>" required class="readonly"
                                    placeholder="Enter UBA Average">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nickname1">Season Tour Avg</label>
                                <input type="text" name="seasonTourAvg" id="seasonTourAvg"
                                    value="<?php echo $dataFetched['seasontourAvg']; ?>" required class="readonly"
                                    placeholder="Enter Season Tour Avg">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sanction" id="sanction"
                                    value="<?php echo $dataFetched['sanction']; ?>" required
                                    placeholder="Enter Bowler's Nickname">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="teamName" id="teamName">
                                    <?php
                                            ...
                                            ?>
                                    <option value="<?php echo $team['teamname'];?>" selected>
                                        <?php echo $team['teamname'];?></option>
                                    <?php
                                                    } else {
                                            ?>
                                    <option value="<?php echo $team['teamname'];?>"><?php echo $team['teamname'];?>
                                    </option>
                                    <?php
                                                    }
                                                }
                        ...
                        ?>
                                ...
                                <select name="officeHeld" id="officeHeld">
                                    ...
                                    if (in_array($dataFetched['officeheld'], $officePosList)) {
                                        for ($i=0; $i < sizeof($officePosList); $i++) { 
                                            ...
                                            ?>
                                    <option value="<?php echo $dataFetched['officeheld']; ?>"
                                        <?php echo 'selected="selected"';?>><?php echo $officePosList[$i];?></option>
                                    <?php
                                            } else {
                                            ?>
                                    <option value="<?php echo $officePosList[$i];?>"><?php echo $officePosList[$i];?>
                                    </option>
                                    <?php
                                            }
                                        }
                            ...
                            ?>
                            <div class="form-group">
                                <p>This bowler is the President or the Owner of the Team. Please contact the UBA admin
                                    to make changes to the Office Held position for this bowler.</p>
                            </div>
                            <?php
                                } else {
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="phone" id="phone" required
                            value="<?php echo $dataFetched['phone']; ?>" placeholder="Enter Bowler's Entering Average">
                    </div>
                    <?php
                                }
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="enterAvg" id="enterAvg" required
                            value="<?php echo $dataFetched['enteringAvg']; ?>"
                            placeholder="Enter Bowler's Entering Average">
                    </div>
                    <?php
                                }
                            ?>
        ...
        <div class="col-12">
            <hr>
            <a href="process/releaseBowler.php?id=<?php echo $bowlerDbID;?>" class="deleteUser"><i
                    class="fas fa-times"></i> Release Bowler</a>
        </div>
        <?php
                    }
                ?>
        ...
        <div class="col-12">
            <hr>
            <a href="process/releaseBowler.php?id=<?php echo $bowlerDbID;?>" class="deleteUser" id="relbowler"><i
                    class="fas fa-times"></i> Release Bowler</a>
            <hr>
            <a href="process/suspendBowler.php?id=<?php echo $bowlerDbID;?>" class="deleteUser" id="susbowler"><i
                    class="fas fa-times"></i> Suspend Bowler</a>
            <hr>
            <a href="process/deleteBowler.php?id=<?php echo $bowlerDbID;?>" class="deleteUser finaldelete"
                id="delbowler"><i class="fas fa-times"></i> Delete Bowler</a>
        </div>
        <?php
                    }
                ?>
