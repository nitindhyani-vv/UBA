<?php
    ...
    if($_SESSION['userrole'] == 'eventstaff' || $_SESSION['userrole'] == 'admin' || $_SESSION['userrole'] == 'bowler' || $_SESSION['userrole'] == 'president' || $_SESSION['userrole'] == 'owner'  || $_SESSION['userrole'] == 'secretary'){
