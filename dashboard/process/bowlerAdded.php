<?php
    ...
    try {
        ...
        $statement = $db->prepare("INSERT INTO bowlers (`bowlerid`, `team`, `name`, `nickname1`, `officeheld`, `enteringAvg`, `sanction`, `president`,`create_at`)
            VALUES(:bowlerID, :teamName, :bowlerName, :nickname1, :officeHeld, :enterAvg, :sanction, :president,:create_at)");
