<?php
    ...
    try {
        ...
        if ($status == 'y') {
            ...
            $sql = "DELETE FROM `presidency` WHERE `bowlerid`='$bowlerUBAID'";
            $db->exec($sql);

            $_SESSION['success'] = 'President Request Approved';
        } else {
            $president = 0;
            ...
            $_SESSION['success'] = 'President Request Denied';
        }
