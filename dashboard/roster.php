        ...
        <div class="row">
            <div class="col-12">
                ...
                ?>
                    ...
                    <?php if (isset($_POST['teamSelected']) || isset($_SESSION['rosterSelected'])) { ?>
                        <input type="hidden" id="teamSelected" value="<?php echo $_SESSION['rosterSelected'];?>">
                        <h4>Team Roster: '<?php echo $_SESSION['rosterSelected']; ?>'
                        </h4>
                        <hr>
                        <div class="row">
